...
static PythonSource PYTHON_SOURCE_NODE_MODULE =
    ...
    "       roll_engine_api.signal_create(entity_id=self.entity_id, signal_id=signal_id)\n"
    "\n"
    "   def connect_signal(self, signal_id: str, listener_node, function_name: str) -> None:\n"
    "       roll_engine_api.signal_create(\n"
    ...
    "       )\n"
    "\n"
    "   def emit_signal(self, args=[]) -> None:\n"
    "       roll_engine_api.signal_emit(entity_id=self.entity_id, args=args)\n"
    "\n"
    "class Timer(Node):\n"
    "   @property\n"
