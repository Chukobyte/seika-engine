...
static PythonSource PYTHON_SOURCE_CAMERA_MODULE =
    ...
    "       zoom_x, zoom_y = roll_engine_api.camera_get_zoom()\n"
    ...
    "       viewport_x, viewport_y = roll_engine_api.camera_get_viewport_position()\n"
...
static PythonSource PYTHON_SOURCE_NODE_MODULE =
    ...
    "       return roll_engine_api.node2D_get_rotation(entity_id=self.entity_id)\n"
    "\n"
    "   @rotation.setter\n"
    "   def rotation(self, value: float) -> None:\n"
    "       roll_engine_api.node2D_set_rotation(entity_id=self.entity_id, rotation=value)\n"
    "\n"
    "class Sprite(Node2D):\n"
    "   @property\n"
    ...
    "       roll_engine_api.animated_sprite_set_animation(\n"
    "           entity_id=self.entity_id, animation_name=animation_name\n"
    "       )\n"
    "\n"
    "   def stop(self) -> None:\n"
    ...
    "   @property\n"
    "   def frame(self) -> int:\n"
    "       return roll_engine_api.animated_sprite_get_frame(entity_id=self.entity_id)\n"
    "\n"
    "   @frame.setter\n"
    "   def frame(self, value: int) -> None:\n"
    "       roll_engine_api.animated_sprite_set_frame(entity_id=self.entity_id, frame=value)\n"
    "\n"
    "   @property\n"
    "   def animation_frames(self) -> int:\n"
    "       return roll_engine_api.animated_sprite_get_animation_frames(entity_id=self.entity_id)\n"
    "\n"
    "   @property\n"
    "   def animation_speed(self) -> int:\n"
    "       return roll_engine_api.animated_sprite_get_animation_speed(entity_id=self.entity_id)\n"
    "\n"
    "   @property\n"
    "   def flip_h(self) -> bool:\n"
