...
static PythonSource PYTHON_SOURCE_AUDIO_MODULE =
    ...
    "       seika_engine_api.audio_play_music(music_id=music_id)\n"
    "\n"
    "   @staticmethod\n"
    "   def stop_music() -> None:\n"
...
static PythonSource PYTHON_SOURCE_CAMERA_MODULE =
    ...
    "       zoom_x, zoom_y = seika_engine_api.camera_get_zoom()\n"
    "       return Vector2(zoom_x, zoom_y)\n"
    "\n"
    "   @staticmethod\n"
    "   def set_zoom(zoom: Vector2) -> None:\n"
    "       seika_engine_api.camera_set_zoom(zoom.x, zoom.y)\n"
    "\n"
    "   @staticmethod\n"
    "   def get_viewport_position() -> Vector2:\n"
    "       viewport_x, viewport_y = seika_engine_api.camera_get_viewport_position()\n"
    "       return Vector2(viewport_x, viewport_y)\n"
    "\n"
    "   @staticmethod\n"
    "   def set_viewport_position(position: Vector2) -> None:\n"
    "       seika_engine_api.camera_set_viewport_position(position.x, position.y)\n"
    "\n"
    "   @staticmethod\n"
    "   def get_offset() -> Vector2:\n"
    "       zoom_x, zoom_y = seika_engine_api.camera_get_offset()\n"
    "       return Vector2(zoom_x, zoom_y)\n"
    "\n"
    "   @staticmethod\n"
    "   def set_offset(offset: Vector2) -> None:\n"
    "       seika_engine_api.camera_set_offset(offset.x, offset.y)\n"
    "\n"
    "";
