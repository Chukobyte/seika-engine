    ...
    void Render() {
        ...
        if (IsEnabled()) {
            for (Entity entity : entities) {
                ...
                Vector2 drawDestinationSize = Vector2(currentFrame.drawSource.w * transform2DComponent.scale.x * camera.zoom.x, currentFrame.drawSource.h * transform2DComponent.scale.y * camera.zoom.y);
