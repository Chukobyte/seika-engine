...
void SceneNodeLoader::ParseComponents(SceneNode &sceneNode, const nlohmann::json &nodeComponentJsonArray, bool enabled) {
...
void SceneNodeLoader::ParseTransform2DComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseTimerComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseSpriteComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseAnimatedSpriteComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseTextLabelComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseColliderComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseTransform3DComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseMaterialComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseTextureCubeComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseDirectionalLightComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParsePointLightComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
void SceneNodeLoader::ParseSpotLightComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
    nlohmann::json directionJson = JsonHelper::Get<nlohmann::json>(nodeComponentObjectJson, "direction");
    Vector3 nodeDirection = Vector3(
                                JsonHelper::Get<float>(directionJson, "x"),
                                JsonHelper::Get<float>(directionJson, "y"),
...
void SceneNodeLoader::ParseScriptableClassComponent(SceneNode &sceneNode, const nlohmann::json &nodeComponentObjectJson, bool enabled) {
...
SceneNodeLoader::SceneNodeLoader(EntityManager *entityM, ComponentManager *componentM, AssetManager *assetM, TimerManager *timerM)
    : entityManager(entityM), componentManager(componentM), assetManager(assetM), timerManager(timerM) {}

SceneNode SceneNodeLoader::ParseSceneJson(nlohmann::json nodeJson, bool isRoot) {
    SceneNode sceneNode;
    if (isRoot) {
